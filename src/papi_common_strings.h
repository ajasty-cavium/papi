...
/* 108 */ {"PAPI_FUOPS_RET",
	  ...
	  "Fused micro-ops retired", 0,
	  0, PAPI_PRESET_BIT_MSC,
	  NULL, {0},{NULL}, NULL},
/* 109 */ {"PAPI_LD_ORDER_FLUSH",
	  "LD order flush",
	  "LD ordering flush", 0,
	  0, PAPI_PRESET_BIT_MSC,
	  NULL, {0},{NULL}, NULL},
/* 110 */ {"PAPI_ST_RMW",
	  "Store RMW events",
	  "Store read-modify-write events", 0,
	  0, PAPI_PRESET_BIT_MSC,
	  NULL, {0},{NULL}, NULL},
/* 111 */ {"PAPI_LL_DETECT",
	  "Livelock detected",
	  "Live-lock even detected", 0,
	  0, PAPI_PRESET_BIT_MSC,
	  NULL, {0},{NULL}, NULL},
/* 112 */ {"PAPI_UNALIGN_LDST_RET",
	  "Unaligned ld/st retired",
	  "Unaligned load-stores retired", 0,
	  0, PAPI_PRESET_BIT_MSC,
	  NULL, {0},{NULL}, NULL},
/* 113 */ {"PAPI_LD_UNSAFE_RETRY",
	  "Unsafe loasds",
	  "Unsafe loads", 0,
	  0, PAPI_PRESET_BIT_MSC,
	  NULL, {0},{NULL}, NULL},
/* 114 */ {"PAPI_LSU_FLUSH",
	  ...
	  0, PAPI_PRESET_BIT_MSC,
	  NULL, {0},{NULL}, NULL},
/* 115 */ {"PAPI_MAP_ISB_EMPTY",
	  "MAP ISB empty",
	  "MAP ISB empty", 0,
	  0, PAPI_PRESET_BIT_MSC,
	  NULL, {0},{NULL}, NULL},
/* 116 */ {"PAPI_MAP_ISB_FULL",
	  "MAP ISB full",
	  "MAP ISB FULL", 0,
	  0, PAPI_PRESET_BIT_MSC,
	  NULL, {0},{NULL}, NULL},
/* 117 */ {"PAPI_MAP_ISB_STL_NOTEMPTY",
	  "MAP ISB empty",
	  "MAP ISB empty", 0,
	  0, PAPI_PRESET_BIT_MSC,
	  NULL, {0},{NULL}, NULL},
/* 118 */ {"PAPI_MAP_LOOPS_ENTERED",
	  "MAP loops entered",
	  "MAP loops entered", 0,
	  0, PAPI_PRESET_BIT_MSC,
	  NULL, {0},{NULL}, NULL},
/* 119 */ {"PAPI_MAP_LOOPS_ENDED",
	  "MAP loops ended",
	  "MAP loops ended", 0,
	  0, PAPI_PRESET_BIT_MSC,
	  NULL, {0},{NULL}, NULL},
/* 120 */ {"PAPI_MAP_LOOPS_FLUSHED",
	  "MAP loops flushed",
	  "MAP loops flushed", 0,
	  0, PAPI_PRESET_BIT_MSC,
	  NULL, {0},{NULL}, NULL},
/* 121 */ {"PAPI_MAP_LOOP_UOPS",
	  "MAP loop uops",
	  "MAP loop uops", 0,
	  0, PAPI_PRESET_BIT_MSC,
	  NULL, {0},{NULL}, NULL},
/* 120 */ {"PAPI_STALL_FRONTEND",
	  "Frontend stalled",
	  "Cycles with frontend stall", 0,
	  0, PAPI_PRESET_BIT_MSC,
	  NULL, {0},{NULL}, NULL},
/* 120 */ {"PAPI_STALL_BACKEND",
	  "Backend stalled",
	  "Cycles with fackend stall", 0,
	  0, PAPI_PRESET_BIT_MSC,
	  NULL, {0},{NULL}, NULL},
